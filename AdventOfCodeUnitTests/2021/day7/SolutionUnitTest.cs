...
namespace AdventOfCodeUnitTests._2021.day7;

public class SolutionUnitTest
{
    private readonly List<string> _fileList = new() {"16,1,2,0,4,2,7,1,2,14"};

    private readonly List<int> _list = new() {16,1,2,0,4,2,7,1,2,14};
